...
async function getPendingRequests(userId) {
  ...
  // Query: lấy các bản ghi mà receiver_id = uid và status = pending
  // Sử dụng Scan vì chúng ta không có GSI trên receiver_id (nếu cần tối ưu, thêm GSI sau)
  const res = await ddbDocClient.send(new ScanCommand({
    TableName: FRIENDS_TABLE,
  ...
  // Với mỗi item, lấy thông tin người gửi từ userService
